...
public class ObjectRepository {
    ...
    private final Map<UUID, Recommendation> recommendations = new HashMap<>(Map.of(
            ...
            UUID.fromString("59efc529-2fff-41af-baff-90ccd7402925"), new Recommendation(UUID.fromString("59efc529-2fff-41af-baff-90ccd7402925"), "Top saving", "Откройте мир выгодных кредитов с нами!\n" +
                    "\n" +
